# users API constants
NEW_TRIP_EXPECTED_REQUEST_HEADERS = ['budget', 'season', 'participants', 'duration', 'country-code', 'interest-points']
NEW_TRIP_OPTIONAL_REQUEST_HEADERS = ['accommodation_type', 'transportation_type', 'city', 'area']
